...
public abstract class RedPacketFrame extends JFrame {
    ...
    private static JLabel input_bg_label = new JLabel(new ImageIcon("pic/01_input.jpg"));
    ...
    private static JLabel open_label = new JLabel(new ImageIcon("pic/02_open_2.gif"));
    private static JLabel open_bg_label = new JLabel(new ImageIcon("pic/02_open_1.jpg"));
    ...
    private static JLabel show_bg_label = new JLabel(new ImageIcon("pic/03_money_1.jpg"));
